    ...
    switch (rotateArr[n]) {
        ...
        case D3:
            ...
            switch (rotateArr[n - 1]) {
                ...
                default:
                    ...
                    for (int i = 0; i < COUNT_SECTION; ++i) {
                        adjacentReversRotate(matrics[1][2][i], matrics[4][2][i],
        ...
        case L3:
            ...
            switch (rotateArr[n - 1]) {
                ...
                default:
                    ...
                    for (int i = 0; i < COUNT_SECTION; ++i) {
                        adjacentReversRotate(matrics[0][i][0], matrics[4][2 - i][2],
        ...
        case M3:
            ...
            switch (rotateArr[n - 1]) {
                ...
                case S:
                case S2:
                case S3: rotateArr[n] = None; break;
